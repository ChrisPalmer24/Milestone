...
export default function Record() {
  ...
  const [editHistoryRecord, setEditHistoryRecord] = useState<AccountHistory | null>(null);
  ...
  useEffect(() => {
    if (accountsHistory) {
      const flattenedHistory = accountsHistory.flatMap(account => account.history);
      // Sort by most recent first
      flattenedHistory.sort((a, b) => 
  ...
  const getAccountName = (accountId: string) => {
    ...
    return account ? `${account.provider} (${account.accountType})` : 'Unknown Account';
  };
